...
struct  X509Store_t1007  : public Object_t
{
	...
	X509Certificate2Collection_t1001 * ___list_2;
	...
	X509Store_t791 * ___store_4;
};
struct X509Store_t1007_StaticFields{
	...
	Dictionary_2_t314 * ___U3CU3Ef__switchU24mapF_5;
};
