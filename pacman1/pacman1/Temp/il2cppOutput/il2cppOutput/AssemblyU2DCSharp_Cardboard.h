...
// Cardboard
struct  Cardboard_t27  : public MonoBehaviour_t2
{
...
struct Cardboard_t27_StaticFields{
	// Cardboard Cardboard::sdk
	Cardboard_t27 * ___sdk_2;
	// UnityEngine.Camera Cardboard::currentMainCamera
	Camera_t30 * ___currentMainCamera_3;
	// StereoController Cardboard::currentController
	StereoController_t31 * ___currentController_4;
	// BaseVRDevice Cardboard::device
	BaseVRDevice_t32 * ___device_15;
	// UnityEngine.RenderTexture Cardboard::stereoScreen
	RenderTexture_t12 * ___stereoScreen_17;
};
